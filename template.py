...
# For the logging format= parameter (in basicConfig), 
# you must use %(...)s placeholders. You cannot use .format() or f-strings here


# It will log only in terminal and not any file.
